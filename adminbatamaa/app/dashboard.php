<?php
  ...
  $jml_kategori = mysqli_num_rows($query2);
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                <h3><?php echo number_format($jml_kategori);?></h3>
              ...
              <a href="tabelkategori.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
